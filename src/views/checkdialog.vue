<template>
  <el-dialog
    ...
    width="30%">
    <el-checkbox :indeterminate="state" v-model="stateAll" @change="handleCheckAllChange">全选</el-checkbox>
    <el-checkbox-group v-model="arr" @change="handleCheckedCitiesChange">
      <el-checkbox v-for="(city,index) in custArr" :label="city.label" :key="index">{{ city.label }}</el-checkbox>
    </el-checkbox-group>
