  ...
  computed: {
    ...
    isFit() {
      return (
        ...
        (this.$parent.$attrs.autoFit === false && this.$attrs.fit !== undefined)
      );
    },
    ...
    minWidth() {
      ...
      const maxOne =  Math.max( this.minLength, this.$attrs.label.length * this.fontRate.CHAR_RATE) * this.fontSize;
          ...
          this.$nextTick(() => {
            ...
            if (this.$scopedSlots.default) {
              ...
              setTimeout(() => {
                ...
                let  fixed = this.$attrs.fixed
                const bodyWrapper =  fixed  ? document.querySelector(  `.el-table__fixed${
                           fixed === "right"
                            ? `-${fixed}`
                            : ""
                        }`
                ...
                if (nodes.length) {
                  ...
                  // this.$set(this, "textAlign", this.$attrs.align);
                }
              }, 0);
            } else {
